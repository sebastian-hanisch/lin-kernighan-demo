...
dieselbe Rundtour wie in der [hill-climbing-demo](https://sebastianhanisch-hill-climbing-demo.streamlit.app/), der [simulated-annealing-demo](https://sebastianhanisch-simulated-annealing-demo.streamlit.app/), der [iterated-local-search-demo](https://sebastianhanisch-iterated-local-search-demo.streamlit.app/), der [variable-neighborhood-search-demo](https://sebastianhanisch-variable-neighborhood-search-demo.streamlit.app/), der [tabu-search-demo](https://sebastianhanisch-tabu-search-demo.streamlit.app/) und der [grasp-demo](https://sebastianhanisch-grasp-demo.streamlit.app/) (ein Depot, n Kundenstopps in einem 100 × 100-km-Gebiet), dieselbe untere Schranke.
...
- **Instanz, Nachbarschaften, Abstieg, Schranke** (`lk_scenario.py`, `lk_tour.py`): wortgleiche Kopien aus der [hill-climbing-demo](https://sebastianhanisch-hill-climbing-demo.streamlit.app/) (per Test gegen eingefrorene Werte), über die [iterated-local-search-demo](https://sebastianhanisch-iterated-local-search-demo.streamlit.app/).
